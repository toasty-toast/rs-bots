...
javac -d .\build  -cp "dependencies/OSBot 2.4.39.jar;" catherby_fisher\CatherbyFisher.java
...
javac -d .\build -cp "dependencies/OSBot 2.4.39.jar;" herb_cleaner\HerbCleaner.java
